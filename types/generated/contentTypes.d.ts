...
export interface ApiAddressAddress extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Saved addresses for authenticated users';
    displayName: 'Address';
  ...
  attributes: {
    ...
    subdistrictId: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiCartCart extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    expiresAt: Schema.Attribute.DateTime;
    items: Schema.Attribute.Component<'product.cart-item', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiReviewReview extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    helpful: Schema.Attribute.BigInteger & Schema.Attribute.DefaultTo<'0'>;
...
export interface ApiStoreSettingStoreSetting extends Struct.SingleTypeSchema {
  collectionName: 'store_setting';
  info: {
